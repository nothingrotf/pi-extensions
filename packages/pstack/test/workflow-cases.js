...
export const workflowCases = [
  ...
  leaf('trail-cross-review', skill('show-me-your-work'), 'judgment and prose'),
  ...
  {
    ...writer('comment-cleanup', skill('no-comments'), 'judgment and prose'),
    type: 'Comment Sicko',
  },
  ...
  leaf('shipping-static', playbook('shipping'), 'judgment and prose'),
  leaf('shipping-runtime', playbook('shipping'), 'judgment and prose', 'verifier'),
  ...
  leaf('orchestrate-static', playbook('orchestrate'), 'judgment and prose'),
  leaf('orchestrate-runtime', playbook('orchestrate'), 'judgment and prose', 'verifier'),
  ...
  leaf('orchestrate-brief-auditor', playbook('orchestrate'), 'judgment and prose'),
  writer('orchestrate-stacker', playbook('orchestrate'), 'refactoring'),
  leaf('orchestrate-babysitter', playbook('orchestrate'), 'judgment and prose', 'verifier'),
