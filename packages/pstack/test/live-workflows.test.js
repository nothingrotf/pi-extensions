...
function objective(scenario) {
  ...
  if (scenario.kind === 'publication')
    return 'Draft local commit and PR text from evidence.md in publication.md inside this disposable destination repository. Do not change product code, push, create a PR, merge, or claim publication success. Report missing acceptance evidence.'
