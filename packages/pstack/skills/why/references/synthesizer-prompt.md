...
5. **Check citations against supplied evidence.** The parent spot-checked citations through the source tools. Preserve each stable reference. If supplied evidence does not support a citation, flag it instead of propagating it.
